...
const empassword = require('../models/empassword');
const transactions = require('../models/transactions');
const attendence = require('../models/attendence');


let dept = ['Litigation','Corporate','Diversity and Risk','Human Resource','Finance and Accounting'];
...
module.exports.userlog = function(req,res){
    ...
    var errors;
    empassword.find({ username: user.username,password:user.pwd}, function (err, docs) {
        console.log(docs);
        if(docs.length==1)
        {
            go = docs[0];      
